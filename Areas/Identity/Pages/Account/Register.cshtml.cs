...
namespace Ajay.PMS.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //{
                //    string fileDictonary = $"wwwroot/UserImage";
                //    if (!Directory.Exists(fileDictonary)) 
                //    {
                //        Directory.CreateDirectory(fileDictonary);
                //    }

                //    string uniquefilename = Guid.NewGuid() + " _" + Input.UserFile.FileName;
                ...
                //        Input.UserUrl = $"UserImage/" + uniquefilename;
                //    }
        ...
        private IUserEmailStore<UserLogin> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<UserLogin>)_userStore;
        }
    }
}
